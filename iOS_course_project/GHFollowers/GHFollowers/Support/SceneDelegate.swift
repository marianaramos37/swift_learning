...
//  GHFollowers
//
//  Created by Mariana Ramos on 28/02/2024.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        window = UIWindow(frame: windowScene.coordinateSpace.bounds) // Occupy entire scene
    ...
    /* Architecture:
     Have two very similar functions instead of one that has to take 5 parameters.
     Keep it simple > blindy follow the DRY rule.
    */
    ...
    func createTabBar() -> UITabBarController {
        ...
        UITabBar.appearance().tintColor = .systemGreen // This appearance is for all tabBars
